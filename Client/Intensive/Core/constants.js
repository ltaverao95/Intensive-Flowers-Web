(function(){
	...
	CoreConstants.BOUQUET_FILES_NAMES = {
		GET_ALL_BOUQUETS_FILE: CoreConstants.BOUQUET_FILES_BASE_PATH + '.php',
		SAVE_BOUQUET_FILE: CoreConstants.BOUQUET_FILES_BASE_PATH + '.php',
		DELETE_ALL_BOUQUETS_FILE: CoreConstants.BOUQUET_FILES_BASE_PATH + '.php',
		DELETE_BOUQUET_BY_ID_FILE: CoreConstants.BOUQUET_FILES_BASE_PATH + '.php',
		DELETE_BOUQUETS_SELECTED_FILE: CoreConstants.BOUQUET_FILES_BASE_PATH + '.php',
		EDIT_BOUQUET_BY_ID_FILE: CoreConstants.BOUQUET_FILES_BASE_PATH + '.php'
	};

	CoreConstants.CONTACT_FILES_NAMES = {
		GET_ALL_CONTACTS_FILE: CoreConstants.CONTACT_FILES_BASE_PATH + '.php',
		SAVE_CONTACT_FILE: CoreConstants.CONTACT_FILES_BASE_PATH + '.php',
	...
	CoreConstants.StoreServiceURL = {
		...
		EDIT_ORDER_BY_ID_URL: CoreConstants.SERVER_API_RELATIVE_PATH + CoreConstants.STORE_FILES_NAMES.EDIT_ORDER_BY_ID_FILE,
	};
